...
function module:init()
    ...
    print("\nThe weather changed")
    print(string.format("approachingfront\t: %s", tostring(game.logic.weather.approachingfront) ))
    print(string.format("postfrontal\t\t: %s", tostring(game.logic.weather.postfrontal) ))
    print(string.format("airTemperature\t\t: %d", game.logic.weather.airTemperature ))
    print(string.format("waterTemperature\t: %d", game.logic.weather.waterTemperature ))
    print(string.format("cloudcover\t\t: %f", game.logic.weather.cloudcover ))
    print(string.format("windSpeed\t\t: %d", game.logic.weather.windSpeed ))
    print(string.format("rain\t\t\t: %s", tostring(game.logic.weather.rain) ))
