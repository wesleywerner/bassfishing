...
# x86_64 build
LAID=laid64
$QEMU_64 -enable-kvm -m 512 -hda $VM_64_DISK -redir tcp:2222::22 -snapshot -nographic &
bootup
make
powerdown
...
# x86 build
LAID=laid32
$QEMU_32 -enable-kvm -m 512 -hda $VM_32_DISK -redir tcp:3333::22 -snapshot -nographic &
bootup
make
powerdown

mv game.love Bass_Lover.love
